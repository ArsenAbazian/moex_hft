...
public:
    ...
    void Test_OnIncrementalRefresh_OBR_FOND_Add() {
        ...
        FastGenericItemInfo *item1 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 3, -2, 1, 2, mduaAdd, mdetBuyQuote, "e1", 1);
        FastGenericItemInfo *item2 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 4, -2, 1, 2, mduaAdd, mdetBuyQuote, "e2", 2);
        FastGenericItemInfo *item3 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 2, -2, 1, 2, mduaAdd, mdetBuyQuote, "e3", 3);
        FastGenericItemInfo *item4 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 25, -3, 1, 2, mduaAdd, mdetBuyQuote, "e4", 4);
        ...
        if(this->incFond->OrderBookFond()->Symbol(0)->Count() != 1)
            throw;
        OrderBookInfo<FastGenericItemInfo> *obi = this->incFond->OrderBookFond()->GetItem("s1", "t1");
        if(obi == 0)
            throw;
    ...
    void Test_OnIncrementalRefresh_OBR_FOND_Change() {
        ...
        OrderBookInfo<FastGenericItemInfo> *obi2 = this->incFond->OrderBookFond()->GetItem("s1", "t1");
        ...
        FastGenericItemInfo *item5 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 24, -3, 1, 3, mduaChange, mdetBuyQuote, "e2", 5);
    ...
    void Test_OnFullRefresh_OBS_FOND() {
        ...
        FastGenericInfo *info2 = this->m_helper->CreateOBSFondInfo("t1s2", "t1");
        FastGenericItemInfo *newItem1 = this->m_helper->CreateOBSFondItemInfo(7,-2, 1, 2, mdetBuyQuote, "e7");
        FastGenericItemInfo *newItem2 = this->m_helper->CreateOBSFondItemInfo(8,-2, 1, 2, mdetBuyQuote, "e8");
        info2->RptSeq = 5;
        ...
        OrderBookInfo<FastGenericItemInfo> *obi3 = this->incFond->OrderBookFond()->GetItem("s1", "t1");
        if(obi3->BuyQuotes()->Count() != 4)
            throw;

        OrderBookInfo<FastGenericItemInfo> *obi = this->incFond->OrderBookFond()->GetItem("t1s2", 4, "t1", 2);
        if(obi->BuyQuotes()->Count() != 2)
            throw;
    ...
    void Test_OnIncrementalRefresh_OBR_FOND_Add_SellQuotes() {
        ...
        FastGenericItemInfo *item1 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 3, -2, 1, 2, mduaAdd, mdetSellQuote, "e1", 1);
        FastGenericItemInfo *item2 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 4, -2, 1, 2, mduaAdd, mdetSellQuote, "e2", 2);
        FastGenericItemInfo *item3 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 2, -2, 1, 2, mduaAdd, mdetSellQuote, "e3", 3);
        FastGenericItemInfo *item4 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 25, -3, 1, 2, mduaAdd, mdetSellQuote, "e4", 4);
    ...
    void Test_OnIncrementalRefresh_OBR_FOND_Change_SellQuotes() {
        ...
        FastGenericItemInfo *item5 = this->m_helper->CreateOBRFondItemInfo("s1", "t1", 24, -3, 1, 3, mduaChange, mdetSellQuote, "e2", 5);
    ...
    void Test_OnFullRefresh_OBS_FOND_SellQuotes() {
        ...
        FastGenericInfo *info2 = this->m_helper->CreateOBSFondInfo("t1s2", "t1");
        FastGenericItemInfo *newItem1 = this->m_helper->CreateOBSFondItemInfo(7,-2, 1, 2, mdetSellQuote, "e7");
        FastGenericItemInfo *newItem2 = this->m_helper->CreateOBSFondItemInfo(8,-2, 1, 2, mdetSellQuote, "e8");
    ...
    void Test_OnIncrementalRefresh_OBR_FOND() {
        printf("OBR FOND Test_OnIncrementalRefresh_OBR_FOND_Add\n");
        Test_OnIncrementalRefresh_OBR_FOND_Add();
        printf("OBR FOND Test_OnIncrementalRefresh_OBR_FOND_Remove\n");
        Test_OnIncrementalRefresh_OBR_FOND_Remove();
        printf("OBR FOND Test_OnIncrementalRefresh_OBR_FOND_Change\n");
        Test_OnIncrementalRefresh_OBR_FOND_Change();
        printf("OBR FOND Test_Clear\n");
        Test_Clear();
    }

    void Test_OnIncrementalRefresh_OBR_FOND_SellQuotes() {
        printf("OBR FOND Test_OnIncrementalRefresh_OBR_FOND_Add_SellQuotes\n");
        Test_OnIncrementalRefresh_OBR_FOND_Add_SellQuotes();
        printf("OBR FOND Test_OnIncrementalRefresh_OBR_FOND_Remove_SellQuotes\n");
        Test_OnIncrementalRefresh_OBR_FOND_Remove_SellQuotes();
        printf("OBR FOND Test_OnIncrementalRefresh_OBR_FOND_Change_SellQuotes\n");
        Test_OnIncrementalRefresh_OBR_FOND_Change_SellQuotes();
        printf("OBR FOND Test_Clear_SellQuotes\n");
        Test_Clear_SellQuotes();
    }

    void Test_Generic() {
        this->m_helper->SetFondMode();
        printf("OBR FOND Test_OnIncrementalRefresh_OBR_FOND\n");
        Test_OnIncrementalRefresh_OBR_FOND();
        printf("OBR FOND Test_OnFullRefresh_OBS_FOND\n");
        Test_OnFullRefresh_OBS_FOND();
        printf("OBR FOND Test_OnIncrementalRefresh_OBR_FOND_SellQuotes\n");
        Test_OnIncrementalRefresh_OBR_FOND_SellQuotes();
        printf("OBR FOND Test_OnFullRefresh_OBS_FOND_SellQuotes\n");
    ...
    void TestTableItem_CorrectBegin() {
        ...
        FastGenericItemInfo *item1 = this->m_helper->CreateOBSFondItemInfo(8, 1, 8, 1, MDEntryType::mdetBuyQuote, "e1");
        item1->RptSeq = 1;
    ...
    void TestTableItem_SkipMessage() {
        ...
        FastGenericItemInfo *item2 = this->m_helper->CreateOBSFondItemInfo(8, 1, 8, 1, MDEntryType::mdetBuyQuote, "e2");
        item2->RptSeq = 3;
        ...
        FastGenericItemInfo *item3 = this->m_helper->CreateOBSFondItemInfo(8, 1, 8, 1, MDEntryType::mdetBuyQuote, "e3");
        item3->RptSeq = 4;
    ...
    void TestTable_AfterClear() {
        ...
        FastGenericItemInfo *item = this->m_helper->CreateOBRFondItemInfo("s1", "session1", "e1");
        item->RptSeq = 1;

        FastGenericItemInfo *item2 = this->m_helper->CreateOBRFondItemInfo("s1", "session1", "e1");
        item2->RptSeq = 2;

        FastGenericItemInfo *item3 = this->m_helper->CreateOBRFondItemInfo("s1", "session1", "e1");
        item3->RptSeq = 4;
    ...
    void TestTable_CorrectBegin() {
        ...
        FastGenericItemInfo *item1 = this->m_helper->CreateOBRFondItemInfo("s1", "session", 8, 1, 8, 1, MDUpdateAction::mduaAdd,
    ...
    void TestTable_SkipMessages() {
        ...
        FastGenericItemInfo *item2 = this->m_helper->CreateOBRFondItemInfo("s1", "session", 8, 1, 8, 1, MDUpdateAction::mduaAdd,
    ...
    void Test_2UsedItemsAfter2IncrementalMessages() {
        ...
        FastGenericItemInfo *item2 = this->m_helper->CreateOBRFondItemInfo("s2", "session", 8, 1, 8, 1, MDUpdateAction::mduaAdd,
                                                           MDEntryType::mdetBuyQuote, "e1", 1);
        item2->RptSeq = 1;
    ...
    void TestTable_CorrectApplySnapshot() {
        ...
        FastGenericItemInfo *item3 = this->m_helper->CreateOBRFondItemInfo("s1", "session", 8, 1, 8, 1, MDUpdateAction::mduaAdd,
        ...
        FastGenericItemInfo *item4 = this->m_helper->CreateOBRFondItemInfo("s1", "session", 8, 1, 8, 1, MDUpdateAction::mduaAdd,
        ...
        FastGenericItemInfo *item5 = this->m_helper->CreateOBRFondItemInfo("s1", "session", 8, 1, 8, 1, MDUpdateAction::mduaAdd,
                                                           MDEntryType::mdetBuyQuote, "e5", 3);
        item5->RptSeq = 3;

        FastGenericInfo *info = this->m_helper->CreateOBSFondInfo("s1", "session");
        info->GroupMDEntriesCount = 1;
        info->GroupMDEntries[0] = item5;
    ...
    void TestTable_CorrectApplySnapshot_2() {
        ...
        FastGenericInfo *info1 = this->m_helper->CreateOBSFondInfo("s1", "session");
        ...
        FastGenericInfo *info2 = this->m_helper->CreateOBSFondInfo("s1", "session");
    ...
    void TestConnectionFond_TestIncMessagesLost_AndWhenAppeared() {
        ...
        OrderBookInfo<FastGenericItemInfo> *item = incFond->OrderBookFond()->GetItem("s1", "session1");
    ...
    void TestConnectionFond_TestSnapshotCollect() {
        ...
        OrderBookInfo<FastGenericItemInfo> *tableItem = incFond->OrderBookFond()->GetItem("s1", "session1");
    ...
    void TestConnectionFond_TestMessagesLost_2Items_SnapshotReceivedForOneItem() {
        ...
        OrderBookInfo<FastGenericItemInfo> *item1 = incFond->OrderBookFond()->GetItem("s1", "session1");
        OrderBookInfo<FastGenericItemInfo> *item2 = incFond->OrderBookFond()->GetItem("s2", "session1");
    ...
    void TestConnectionFond_ClearSnapshotMessages() {
        printf("OBR FOND TestConnectionFond_ClearSnapshotMessages_1\n");
        TestConnectionFond_ClearSnapshotMessages_1();
        printf("OBR FOND TestConnectionFond_ClearSnapshotMessages_2\n");
        TestConnectionFond_ClearSnapshotMessages_2();
        printf("OBR FOND TestConnectionFond_ClearSnapshotMessages_3\n");
        TestConnectionFond_ClearSnapshotMessages_3();
        printf("OBR FOND TestConnectionFond_ClearSnapshotMessages_4\n");
        TestConnectionFond_ClearSnapshotMessages_4();
    }
    void TestConnectionFond_ParallelWorkingIncrementalAndSnapshot() {
        printf("OBR FOND TestConnectionFond_EnterSnapshotMode\n");
        TestConnectionFond_EnterSnapshotMode();
        printf("OBR FOND TestConnectionFond_ClearSnapshotMessages\n");
        TestConnectionFond_ClearSnapshotMessages();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_1\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_1();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_2\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_2();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_2_1\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_2_1();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_3\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_3();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_3_1\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_3_1();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_4\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_4();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_1\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_1();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_2\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_2();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_2_2\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_2_2();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_3\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_3();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_4\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_4();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_4_1\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_4_1();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_4_2\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_4_2();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_5\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_5();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_5_1\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_5_1();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_6\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_6();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot_5_7\n");
    ...
    void TestConnectionFond() {
        this->m_helper->SetFondMode();
        printf("OBR FOND TestConnectionFond_AllSymbolsAreOk\n");
        TestConnectionFond_AllSymbolsAreOk();
        printf("OBR FOND TestConnectionFond_ResetEntriesQueueIfNullSnapshotIsReceived\n");
        TestConnectionFond_ResetEntriesQueueIfNullSnapshotIsReceived();
        printf("OBR FOND TestConnectionFond_AllSymbolsAreOkButOneMessageLost\n");
        TestConnectionFond_AllSymbolsAreOkButOneMessageLost();
        printf("OBR FOND TestConnectionFond_SkipHearthBeatMessages_Incremental\n");
        TestConnectionFond_SkipHearthBeatMessages_Incremental();
        printf("OBR FOND TestConnectionFond_ParallelWorkingIncrementalAndSnapshot\n");
        TestConnectionFond_ParallelWorkingIncrementalAndSnapshot();
        printf("OBR FOND TestConnectionFond_NotAllSymbolsAreOk\n");
        TestConnectionFond_NotAllSymbolsAreOk();
        printf("OBR FOND TestConnectionFond_StopListeningSnapshotBecauseAllItemsIsUpToDate\n");
        TestConnectionFond_StopListeningSnapshotBecauseAllItemsIsUpToDate();
        printf("OBR FOND TestConnectionFond_StopTimersAfterReconnect\n");
        TestConnectionFond_StopTimersAfterReconnect();
        printf("OBR FOND TestConnectionFond_SnapshotSomeMessagesReceivedLater\n");
        TestConnectionFond_SnapshotSomeMessagesReceivedLater();
        printf("OBR FOND TestConnectionFond_SnapshotSomeMessagesNotReceived\n");
        TestConnectionFond_SnapshotSomeMessagesNotReceived();
        printf("OBR FOND TestConnectionFond_LastFragmentReceivedBeforeRouteFirst\n");
        TestConnectionFond_LastFragmentReceivedBeforeRouteFirst();
        printf("OBR FOND TestConnectionFond_RouteFirstReceived_AfterSomeDummyMessages\n");
        TestConnectionFond_RouteFirstReceived_AfterSomeDummyMessages();
        printf("OBR FOND TestConnectionFond_RouteFirstReceived_Empty\n");
        TestConnectionFond_RouteFirstReceived_Empty();
        printf("OBR FOND TestConnectionFond_TestSnapshotNoMessagesAtAll\n");
        TestConnectionFond_TestSnapshotNoMessagesAtAll();
        printf("OBR FOND TestConnectionFond_OneMessageReceived\n");
        TestConnectionFond_OneMessageReceived();
        printf("OBR FOND TestConnectionFond_Clear_AfterIncremental\n");
        TestConnectionFond_Clear_AfterIncremental();
        printf("OBR FOND TestConnectionFond_TestIncMessageLost_AndWaitTimerElapsed\n");
        TestConnectionFond_TestIncMessageLost_AndWaitTimerElapsed();
        printf("OBR FOND TestConnectionFond_TestSnapshotCollect\n");
        TestConnectionFond_TestSnapshotCollect();
        printf("OBR FOND TestConnectionFond_TestSnapshotNotCollect\n");
        TestConnectionFond_TestSnapshotMessageLostAndTimeExpired();
        printf("OBR FOND TestConnectionFond_TestMessagesLost_2Items_SnapshotReceivedForOneItem\n");
        TestConnectionFond_TestMessagesLost_2Items_SnapshotReceivedForOneItem();

        printf("OBR FOND TestConnectionFond_EmptyTest\n");
        TestConnectionFond_EmptyTest();
        printf("OBR FOND TestConnectionFond_TestCorrectIncMessages\n");
        TestConnectionFond_TestCorrectIncMessages();
        printf("OBR FOND TestConnectionFond_TestIncMessagesLost_AndWhenAppeared\n");
        TestConnectionFond_TestIncMessagesLost_AndWhenAppeared();
        printf("OBR FOND TestConnectionFond_TestInc2MessagesLost_AppearedThen2Messages\n");
        TestConnectionFond_TestInc2MessagesLost_AppearedThen2Messages();
        printf("OBR FOND TestConnectionFond_TestInc2MessagesLost_AppearedSeparately_1_2\n");
        TestConnectionFond_TestInc2MessagesLost_AppearedSeparately_1_2();
        printf("OBR FOND TestConnectionFond_TestInc2MessagesLost_AppearedSeparately_2_1\n");
        TestConnectionFond_TestInc2MessagesLost_AppearedSeparately_2_1();
    }

    void TestOrderBookTableItem() {
        printf("OBR FOND TestTableItem_CorrectBegin\n");
        TestTableItem_CorrectBegin();
        printf("OBR FOND TestTableItem_IncorrectBegin\n");
        TestTableItem_IncorrectBegin();
        printf("OBR FOND TestTableItem_SkipMessage\n");
        TestTableItem_SkipMessage();
        printf("OBR FOND TestTable_Default\n");
        TestTable_Default();
        printf("OBR FOND TestTable_AfterClear\n");
        TestTable_AfterClear();
        printf("OBR FOND TestTable_CorrectBegin\n");
        TestTable_CorrectBegin();
        printf("OBR FOND TestTable_IncorrectBegin\n");
        TestTable_IncorrectBegin();
        printf("OBR FOND TestTable_SkipMessages\n");
        TestTable_SkipMessages();
        printf("OBR FOND Test_2UsedItemsAfter2IncrementalMessages\n");
        Test_2UsedItemsAfter2IncrementalMessages();
        printf("OBR FOND TestTable_CorrectApplySnapshot\n");
        TestTable_CorrectApplySnapshot();
        printf("OBR FOND TestTable_CorrectApplySnapshot_2\n");
        TestTable_CorrectApplySnapshot_2();
        printf("OBR FOND TestTable_IncorrectApplySnapshot\n");
        TestTable_IncorrectApplySnapshot();
        printf("OBR FOND TestTable_IncorrectApplySnapshot_WhenMessageSkipped\n");
    ...
    void TestInfoAndItemInfoUsageAndAllocationFond_Inc_4() {
        FastGenericItemInfo *info = this->m_helper->CreateOBSFondItemInfo(1, 1, 1, 1, MDEntryType::mdetBuyQuote, "e1");
    ...
    void TestInfoAndItemInfoUsageAndAllocationFond() {
        this->m_helper->SetFondMode();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Inc_1\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Inc_1();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Inc_2\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Inc_2();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Inc_3\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Inc_3();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Inc_4\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Inc_4();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Inc_5\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Inc_5();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Snap_1\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Snap_1();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Snap_2\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Snap_2();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Snap_3\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Snap_3();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Snap_4\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Snap_4();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Snap_5\n");
        TestInfoAndItemInfoUsageAndAllocationFond_Snap_5();
        printf("OBR FOND TestInfoAndItemInfoUsageAndAllocationFond_Snap_6\n");
