...
class OrderBookTesterFond {
    ...
    MarketDataTable<OrderBookInfo, FastOBSFONDInfo, FastOBSFONDItemInfo> *m_table;

public:
    OrderBookTesterFond() {
        this->m_helper = new TestMessagesHelper();
        this->m_table = new MarketDataTable<OrderBookInfo, FastOBSFONDInfo, FastOBSFONDItemInfo>();
