...
public:
    ...
    void Test_OnIncrementalRefresh_OLR_FOND_Change() {
        ...
        OrderTableItem<FastOLSFONDItemInfo> *obi2 = this->fcf->OrderFond()->GetItem("SMB1", 4, "TRADING001", 10);
    ...
    void Test_OnFullRefresh_OLS_FOND() {
        ...
        OrderTableItem<FastOLSFONDItemInfo> *obi3 = this->fcf->OrderFond()->GetItem("SMB1", 4, "TRADING001", 10);
        if(obi3->BuyQuotes()->Count() != 0)
            throw;

        OrderTableItem<FastOLSFONDItemInfo> *obi = this->fcf->OrderFond()->GetItem("SMB2", 4, "TRADING001", 10);
        if(obi->BuyQuotes()->Count() != 2)
            throw;
    ...
    void Test_OnIncrementalRefresh_OLR_CURR_Change() {
        ...
        OrderTableItem<FastOLSCURRItemInfo> *obi2 = this->fcc->OrderCurr()->GetItem("SMB1", 4, "TRADING001", 10);
        if(!StringIdComparer::Equal(obi2->BuyQuotes()->Item(0)->MDEntryID, 10, "ENTRYID001", 10))
            throw;
        if(!StringIdComparer::Equal(obi2->BuyQuotes()->Item(1)->MDEntryID, 10, "ENTRYID002", 10))
            throw;
    ...
    void Test_OnFullRefresh_OLS_CURR() {
        ...
        OrderTableItem<FastOLSCURRItemInfo> *obi3 = this->fcc->OrderCurr()->GetItem("SMB1", 4, "TRADING001", 10);
        if(obi3->BuyQuotes()->Count() != 0)
            throw;

        OrderTableItem<FastOLSCURRItemInfo> *obi = this->fcc->OrderCurr()->GetItem("SMB2", 4, "TRADING001", 10);
        if(obi->BuyQuotes()->Count() != 2)
            throw;
