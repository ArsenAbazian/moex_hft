...
//	robot->AllowFortsMarket(false);
	...
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidFutBook5, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidFutBook20, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidFutBook50, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidFutTrades, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidOptBook1, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidOptBook5, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidOptBook20, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidOptBook50, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidOptTrades, true);
	robot->AllowMarketDataGroup(MarketDataGroupId::mdgidOtcTrades, true);
